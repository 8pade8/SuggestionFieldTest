package com.company.suggestionfieldtest;
...
public class SuggestionfieldtestTestContainer extends TestContainer {

    public SuggestionfieldtestTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/suggestionfieldtest/app.properties",
    ...
    public static class Common extends SuggestionfieldtestTestContainer {

        public static final SuggestionfieldtestTestContainer.Common INSTANCE = new SuggestionfieldtestTestContainer.Common();
